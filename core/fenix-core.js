...
(()=>{
  ...
  addStyle("v2","fenix-v2.css?v=0.18.0");addStyle("variants","fenix-theme-overrides.css?v=0.18.0");addStyle("studio-shell","studio-shell.css?v=0.20.2");addStyle("fenix-mode","fenix-mode.css?v=0.22.11");
  ...
  window.addEventListener("DOMContentLoaded",()=>{if(document.body?.dataset?.module||document.body?.dataset?.screen)addScript("studio-shell","studio-shell.js?v=0.22.11")},{once:true});
})();
