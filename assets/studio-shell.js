...
(()=>{
  ...
  if(!document.getElementById("fenixUnifiedStudioUx")){
    ...
    style.textContent=`
      ...
      body.fenix-studio-shell .studio-layout{
        display:flex!important;flex-direction:column!important;grid-template-columns:1fr!important;align-items:stretch!important;width:min(1500px,100%)!important;margin:0 auto!important;gap:18px!important;
      }
      ...
      body.fenix-studio-shell .panel,
      body.fenix-studio-shell .controls,
      body.fenix-studio-shell .card.controls,
      body.fenix-studio-shell .ctp-panel{position:static!important;top:auto!important;max-height:none!important;overflow:visible!important;width:100%!important}
      body.fenix-studio-shell .preview,
      body.fenix-studio-shell .workspace,
      body.fenix-studio-shell .hero,
      body.fenix-studio-shell .ctp-preview{width:100%!important;grid-column:1!important;grid-row:auto!important}
      ...
      html[data-theme=dark] body.fenix-studio-shell button[data-fenix-action=variant],html[data-theme=dark] body.fenix-studio-shell button[data-fenix-action=reset]{background:#263746!important;border-color:#405467!important;color:#f3f7fa!important}
