...
window.FenixBookProductionRenderers=(()=>{
  ...
  async function snapshot(data,quality){
    const img=await loadImage(data),scale=quality==="print"?3:1,c=makeCanvas(scale),ctx=c.getContext("2d");
    ctx.fillStyle="#fff";ctx.fillRect(0,0,850,1100);ctx.drawImage(img,0,0,850,1100);return c;
  }
