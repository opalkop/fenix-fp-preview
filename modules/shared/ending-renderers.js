...
window.FenixEndingRenderers=(()=>{
  ...
  function renderCertificate(settings,width,height,creatorMarkImage=null){
    ...
    const fieldY=2500*s;ctx.lineWidth=3*s;ctx.font=`400 ${32*s}px Arial, sans-serif`;if(settings.showDate&&settings.showSignature){ctx.beginPath();ctx.moveTo(390*s,fieldY);ctx.lineTo(1080*s,fieldY);ctx.moveTo(1470*s,fieldY);ctx.lineTo(2160*s,fieldY);ctx.stroke();ctx.fillText(settings.dateLabel,735*s,fieldY+60*s);ctx.fillText(settings.signatureLabel,1815*s,fieldY+60*s)}else if(settings.showDate){ctx.beginPath();ctx.moveTo(765*s,fieldY);ctx.lineTo(1785*s,fieldY);ctx.stroke();ctx.fillText(settings.dateLabel,cx,fieldY+60*s)}else if(settings.showSignature){ctx.beginPath();ctx.moveTo(765*s,fieldY);ctx.lineTo(1785*s,fieldY);ctx.stroke();ctx.fillText(settings.signatureLabel,cx,fieldY+60*s)}
