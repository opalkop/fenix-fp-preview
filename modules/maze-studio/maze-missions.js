...
(()=>{
 ...
 (async()=>{try{await load("maze-engine.js?v=0.29.5");await load("maze-render-fix.js?v=0.29.5");await load("maze-difficulty.js?v=0.29.5");const trigger=document.getElementById("startAssetScale");if(trigger)trigger.dispatchEvent(new Event("input",{bubbles:true}))}catch(error){console.error("Maze advanced engine bootstrap failed",error)}})();
})();